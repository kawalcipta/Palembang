...
// ambil daftar berita
$dataBerita = curl($api. "?request=berita");
$beritas = json_decode($dataBerita, TRUE);

$dataLabel = curl("http://localhost/iht/palembang/api.php?request=label&bahasa=id&kategori=head");
$labels = json_decode($dataLabel, TRUE);
              ...
              <div class="single-blog">
                ...
                <div class="blog-meta">
                  ...
                  <span class="date-type">
                    <i class="fa fa-calendar"></i><?=$berita['tgl_publish']?>
                  </span>
                </div>
                <div class="blog-text">
                  <h4>
